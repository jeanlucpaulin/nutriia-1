...
public class Chapitre1Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        openWebViewButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Intent intent = new Intent(Chapitre1Activity.this, WebViewActivity.class);
                // Ajoutez l'URL du site Web en tant que données supplémentaires
                intent.putExtra("url", "https://nutriia.fr//fr//fundamentals-of-nutrition-inapp//");
